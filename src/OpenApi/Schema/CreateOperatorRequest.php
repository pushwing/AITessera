...
/**
 * OpenAPI 컴포넌트 — 운영자에 의한 계정 생성 요청 본문(이슈 #29·#34).
 *
 * `role` 은 운영자(1)·대행사(2)·일반회원(3)을 허용한다. 약관 동의 필드는 받지 않으며, 서버가 생성 시각을 채운다.
 */
#[OA\Schema(
    schema: 'CreateOperatorRequest',
    description: '운영자·대행사·일반회원 계정 생성 정보. 운영자 토큰으로만 호출한다.',
    ...
    properties: [
        ...
        new OA\Property(property: 'role', type: 'integer', description: '회원구분 1=운영자 2=대행사 3=일반회원', enum: [1, 2, 3], example: 2),
